...
public class ScrapperWithoutShutdownHook {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            rs = stmt.executeQuery("select Registration.userId, "
                    ...
                    + "Registration.email not like \"%dcis.net\" and "
                    + "Registration.email not like \"%immigrationdirect.com\" and "
                    + "Registration.email not like \"testpayment%\" and "
    ...
    public static AppDetails getAppDetails(int userId, int appId, String nativeMode, String nativeCountry) {
        ...
        String couplePlans = "-4-5-6-12-13-14-7-11-15-19-";
        String plan = "1";
    ...
    public static int plans(int pId) {
        String one = "/1/4/8/12/16/";
        String two = "/2/5/9/13/17/";
        String four = "/3/6/10/14/18/";
        String multi = "/7/11/15/19/";
